...
#
# Slight modifications, such as the edited "convert_ldm_vae_checkpoint_from_file"
# function added by Cadaeic/TeuthisDreams
#
#
...
def create_unet_diffusers_config(original_config, image_size: int):
    ...
    block_out_channels = [unet_params.model_channels *
                          mult for mult in unet_params.channel_mult]
...
def convert_open_clip_checkpoint(checkpoint):
    ...
    text_model_dict["text_model.embeddings.position_ids"] = text_model.text_model.embeddings.get_buffer(
        "position_ids")
        ...
        if key.startswith("cond_stage_model.model.transformer."):
            ...
            if new_key.endswith(".in_proj_weight"):
                ...
                text_model_dict[new_key +
                                ".q_proj.weight"] = checkpoint[key][:d_model, :]
                text_model_dict[new_key +
                                ".k_proj.weight"] = checkpoint[key][d_model: d_model * 2, :]
                text_model_dict[new_key +
                                ".v_proj.weight"] = checkpoint[key][d_model * 2:, :]
...
def convert_ldm_vae_checkpoint_from_file(checkpoint, config):
    # extract state dict for VAE
