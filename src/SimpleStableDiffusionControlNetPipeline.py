...
import diffusers
import PIL
from diffusers import SchedulerMixin, StableDiffusionControlNetPipeline
...
def get_prompts_with_weights(pipe: StableDiffusionControlNetPipeline, prompt: List[str], max_length: int):
    r"""
...
class SimpleStableDiffusionControlNetPipeline(StableDiffusionControlNetPipeline):
    r"""
        ...
        **kwargs,
        ...
        Args:
            ...
            return_dict (`bool`, *optional*, defaults to `True`):
                Whether or not to return a [`~pipelines.stable_diffusion.StableDiffusionControlNetPipelineOutput`] instead of a
                plain tuple.
        ...
        Returns:
            ...
            [`~pipelines.stable_diffusion.StableDiffusionControlNetPipelineOutput`] or `tuple`:
            [`~pipelines.stable_diffusion.StableDiffusionControlNetPipelineOutput`] if `return_dict` is True, otherwise a `tuple.
        ...
        # preparing controlnet image
        c_image = self.prepare_image(
            controlnet_image,
            width,
            height,
